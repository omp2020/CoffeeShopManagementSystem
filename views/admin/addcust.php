...
<head>
    ...
    <title>Admin Dashboard | Add Customer</title>
	    ...
	    <div class="col-md-12">
	        <div class="card">
	            <div class="card-header">
	                <h4 class="card-title" id="striped-row-layout-basic">Customer Details</h4>
	                ...
	                <div class="card-body">
	                    <form class="form form-horizontal striped-rows form-bordered">
	                        ...
	                        <div class="form-actions">
	                            ...
	                            <button id="addcust" class="btn btn-success">
...
<!-- // Striped row layout section end -->
    ...
    <script>
      $('#addcust').click(function(e) {
        ...
        type: 'POST',
        url: '/miniproject/api',
        data:  {name: name, email: email, phone: phone, address: address, type: 'AddCust'},
