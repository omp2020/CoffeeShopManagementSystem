  ...
  <body class="vertical-layout vertical-compact-menu 2-columns   menu-expanded fixed-navbar" data-open="click" data-menu="vertical-compact-menu" data-col="2-columns">
      ...
      <div class="content-wrapper">
        <div class="content-header row">
          <div class="content-header-left col-md-6 col-12 mb-2">
            <h3 class="content-header-title">Update Product Details</h3>
          </div>
        </div>
            ...
            <div class="card-content collapse show">
                <div class="card-body">
                    <div class="form-group row">
                        <label class="col-md-3 label-control" for="name">Product</label>
                        <div class="col-md-9">
                    ...
                    <form class="form form-horizontal striped-rows form-bordered" style="display: none">
	                        ...
	                        <div class="form-actions">
	                            ...
	                            <button id="updateprod" class="btn btn-success">
    ...
    <script>
      ...
      $('#updateprod').click(function(e) {
        ...
        type: 'POST',
        url: '/miniproject/api',
        data:  {id: id, name: name, price: price, stock: stock, desc: desc, type: 'UpdateProd'},
        success: function(data){
            console.log(data);
            data = JSON.parse(data);
          if(data["error"] == 1) {
